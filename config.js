...
// v2026.06.20-43.8.1 Code_v143化・ログイン列ズレ修正
// GASを再デプロイしてURLが変わった場合は GAS_URL だけ変更します。
window.GENBA_CONFIG = {
  APP_NAME: 'Gen-Can',
  APP_VERSION: 'v2026.06.20-43.8.1',
  BUILD: '20260620-v43-8-1-cache-lock',
  TEST_LOGIN_ENABLED: true, // テスト完了後は false に戻す、または削除してください
